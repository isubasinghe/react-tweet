...
var Footer = function (_React$Component) {
  ...
  function Footer(props) {
    ...
    if (_this.props.onTweetAction !== undefined) {
      _this.onTweetAction = function (actionType) {
        return function (e) {
          e.preventDefault();
          _this.props.onTweetAction(actionType, _this.props.data);
        };
      };
    }
    return _this;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'button',
              { className: 'ProfileTweet-actionButton', style: _styles2.default.ProfileTweetActionBtn, onClick: this.onTweetAction("reply") },
              _react2.default.createElement(
                'div',
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'button',
              { className: 'ProfileTweet-actionButton', style: _styles2.default.ProfileTweetActionBtn, onClick: this.onTweetAction("retweet") },
              _react2.default.createElement(
                'div',
                { className: 'IconContainer', style: _styles2.default.IconContainer },
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'button',
              { className: 'ProfileTweet-actionButton', style: _styles2.default.ProfileTweetActionBtn, onClick: this.onTweetAction("favourite") },
              _react2.default.createElement(
                'div',
                { className: 'IconContainer', style: _styles2.default.IconContainer },
