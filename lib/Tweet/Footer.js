...
var Footer = function (_React$Component) {
  ...
  function Footer(props) {
    ...
    if (_this.props.onTweetAction !== undefined) {
      _this.onTweetAction = function (e) {
        e.preventDefault();
        _this.props.onTweetAction(e.target.dataset.actiontype, _this.props.data);
      };
    }
    return _this;
  }
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'a',
          (0, _extends3.default)({ className: 'ProfileTweet-actionList', style: _styles2.default.ProfileTweetActionList, href: 'http://twitter.com/' + data.user.screen_name + '/status/' + data.id_str }, linkProps, { onClick: this.onTweetAction }),
          _react2.default.createElement(
            'div',
            { className: 'ProfileTweet-action', style: _styles2.default.ProfileTweetAction },
            _react2.default.createElement(
              'button',
              { className: 'ProfileTweet-actionButton', 'data-actiontype': 'reply', style: _styles2.default.ProfileTweetActionBtn },
              _react2.default.createElement(
                'div',
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'button',
              { className: 'ProfileTweet-actionButton', 'data-actiontype': 'retweet', style: _styles2.default.ProfileTweetActionBtn },
              _react2.default.createElement(
                'div',
                { className: 'IconContainer', style: _styles2.default.IconContainer },
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'button',
              { className: 'ProfileTweet-actionButton', 'data-actiontype': 'favourite', style: _styles2.default.ProfileTweetActionBtn },
              _react2.default.createElement(
                'div',
                { className: 'IconContainer', style: _styles2.default.IconContainer },
