  ...
  (0, _createClass3.default)(Tweet, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          tweetStyles = _props.tweetStyles,
          onTweetAction = _props.onTweetAction,
          onMediaLoad = _props.onMediaLoad,
          onMediaLoadError = _props.onMediaLoadError,
          isRT = false;
      ...
      if (data.entities && data.entities.media) {
        MediaComponent = _react2.default.createElement(_Media2.default, { autoPlay: this.props.autoPlay, media: data.entities.media, onMediaLoad: onMediaLoad, onMediaLoadError: onMediaLoadError });
      }

      // extended_entities override, these are multi images, videos, gifs
      if (data.extended_entities && data.extended_entities.media) {
        MediaComponent = _react2.default.createElement(_Media2.default, { autoPlay: this.props.autoPlay, media: data.extended_entities.media, onMediaLoad: onMediaLoad, onMediaLoadError: onMediaLoadError });
      }
      ...
      return _react2.default.createElement(
        'div',
        { className: 'tweet', style: (0, _assign2.default)({}, _styles2.default.tweet, tweetStyles) },
        ...
        _react2.default.createElement(
          ...
          MediaComponent,
          QuoteComponent,
          _react2.default.createElement(_Footer2.default, { data: data, linkProps: linkProps, onTweetAction: onTweetAction })
        ),
...
Tweet.propTypes = {
  ...
  'tweetStyles': _propTypes2.default.object,
  'onTweetAction': _propTypes2.default.func,
  'onMediaLoad': _propTypes2.default.func,
  'onMediaLoadError': _propTypes2.default.func
};
