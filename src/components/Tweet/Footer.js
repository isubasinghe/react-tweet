...
class Footer extends React.Component {
  constructor(props) {
      ...
      if(this.props.onTweetAction !== undefined) {
        this.onTweetAction = (actionType) => (e) => {
          e.preventDefault()
          this.props.onTweetAction(actionType, this.props.data)
        }
      }
  }
      ...
      <div className="footer" style={styles.footer}>
        <a className="ProfileTweet-actionList" style={styles.ProfileTweetActionList} href={`http://twitter.com/${data.user.screen_name}/status/${data.id_str}`} {...linkProps}>
          <div className="ProfileTweet-action" style={styles.ProfileTweetAction}>
            <button className="ProfileTweet-actionButton" style={styles.ProfileTweetActionBtn} onClick={this.onTweetAction("reply")}>
          ...
          <div className="ProfileTweet-action" style={styles.ProfileTweetAction}>
            <button className="ProfileTweet-actionButton" style={styles.ProfileTweetActionBtn} onClick={this.onTweetAction("retweet")}>
              <div className="IconContainer" style={styles.IconContainer}>
          ...
          <div className="ProfileTweet-action" style={styles.ProfileTweetAction}>
            <button className="ProfileTweet-actionButton" style={styles.ProfileTweetActionBtn} onClick={this.onTweetAction("favourite")}>
              <div className="IconContainer" style={styles.IconContainer}>
